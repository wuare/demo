...
public class Lexer {
    ...
    static {
        ...
        RESERVED_KEYWORDS.put(TokenType.FOR.getText(), TokenType.FOR);
        RESERVED_KEYWORDS.put(TokenType.FOREACH.getText(), TokenType.FOREACH);
        RESERVED_KEYWORDS.put(TokenType.IN.getText(), TokenType.IN);
